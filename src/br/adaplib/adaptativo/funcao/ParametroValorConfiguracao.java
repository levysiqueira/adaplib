...
/**
 * Representa um parâmetro passado por valor que é uma configuração.
 * @author FLevy
 * @since 2.0
 */
public class ParametroValorConfiguracao extends ParametroValor implements ParametroConfiguracao {
	/**
	 * Cria um novo parâmetro por valor, representando uma configuração.
	 * @param valor O nome da configuração.
	 */
